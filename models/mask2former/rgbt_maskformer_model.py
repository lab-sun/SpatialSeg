...
class RGBTMaskFormer(nn.Module):
    ...
    def forward(self, batched_inputs):
        ...
        if self.training:
            ...
            # images shape: torch.Size([4, 4, 256, 320])
            # gt_instances[0] shape: torch.Size([5, 240, 320])
            # gt_instances[1] shape: torch.Size([2, 240, 320])
            # gt_instances[2] shape: torch.Size([3, 240, 320])
            # gt_instances[3] shape: torch.Size([4, 240, 320])
            # targets[0]['masks'] shape: torch.Size([5, 256, 320])
            # targets[1]['masks'] shape: torch.Size([2, 256, 320])
            # targets[2]['masks'] shape: torch.Size([3, 256, 320])
            # targets[3]['masks'] shape: torch.Size([4, 256, 320])
            # pred_masks shape: torch.Size([4, 100, 64, 80])
