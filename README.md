...
## 📂 Dataset
* Download our pre-processed MF dataset from [here](https://nas.labsun.org/downloads/2026_tro_spatial/MF_Dataset.zip).
...
The inspiration and analytical approach of this paper are draw from [ZoneEval](https://github.com/Zzh-tju/ZoneEval).
